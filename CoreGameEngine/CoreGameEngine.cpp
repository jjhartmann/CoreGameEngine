...
// Load Shader
static GLchar* LoadShader(string filename){
...
static void UnloadShader(GLchar *shader)
{
    if (shader != nullptr)
    {
        delete[] shader;
...
static void CompileShader() {
    ...
    GLchar *vertexShader = LoadShader("simpleshader.vert");
    GLchar *fragmentShader = LoadShader("simpleshader.frag");
